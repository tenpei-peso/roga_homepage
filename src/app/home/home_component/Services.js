...
export default function Services() {
  return (
    <div>
      ...
      <Spacer y={8} />
      <p className="text-left text-sm font-semibold max-w-xl mx-auto">
      プロ訓練士があなたの愛犬のしつけをお手伝いします。高い技術と経験を活かし、愛犬とより充実した毎日を過ごせるようしっかりサポートします。どのコースが自分の子に合っていのかわからない方は、カウンセリング等していきながら相談させて頂きますのでご安心ください！どうぞ、お気軽にご相談ください。
      </p>
    </div>
  );
}
